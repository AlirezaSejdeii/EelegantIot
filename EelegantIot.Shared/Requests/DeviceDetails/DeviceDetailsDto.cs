...
public class DeviceDetailsDto(double current, double voltage, double temperature, double humidity, SettingMode settingMode, TimeOnly startAt, TimeOnly endAt, int[]? workingDays)
{
